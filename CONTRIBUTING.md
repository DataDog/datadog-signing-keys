...
In order to ease/speed up our review, here are some items you can check/improve when submitting your PR:
  ...
  * Preferably, make sure that all tests pass.
...
Avoid changing too many things at once. For instance if you're fixing two different issues at once, it makes reviewing harder and the _time-to-release_ longer.
...
Need help? Contact [Datadog support][support]
